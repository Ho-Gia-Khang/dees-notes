...
import { enable, isEnabled } from "../../scripts/autocast.js";
import "../../elements/emby-checkbox/emby-checkbox.js";
import "../../elements/emby-button/emby-button.js";
import dialog from "../dialog/dialog.js";
import dialogHelper from "../dialogHelper/dialogHelper.js";
...
export function show(button) {
    ...
    playbackManager
        ...
        .then(function (targets) {
            ...
            import("../actionSheet/actionSheet.js")
                .then((actionsheet) => {
                    loading.hide();
                    ...
                    if (
                        !(
                            ...
                            appHost.supports("castmenuhashchange")
                        )
                    ) {
                    ...
                    if (!isChromecastPluginLoaded) {
                        menuOptions.text = `(${globalize.translate(
