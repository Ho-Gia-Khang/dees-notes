...
import datetime from "../../scripts/datetime.js";
import appSettings from "../../scripts/settings/appSettings.js";
import itemHelper from "../itemHelper.js";
import { pluginManager } from "../pluginManager.js";
import PlayQueueManager from "./playqueuemanager.js";
import * as userSettings from "../../scripts/settings/userSettings.js";
import globalize from "../../lib/globalize/index.js";
import loading from "../loading/loading.js";
import { appHost } from "../apphost.js";
import ServerConnections from "../ServerConnections.js";
import alert from "../alert.js";
import { PluginType } from "../../types/plugin.js";
import { includesAny } from "../../utils/container.js";
import { getItems } from "../../utils/jellyfin-apiclient/getItems.js";
import { getItemBackdropImageUrl } from "../../utils/jellyfin-apiclient/backdropImage.js";
...
import { bindSkipSegment } from "./skipsegment.js";
...
export class PlaybackManager {
    constructor() {
        ...
        async function getSeriesOrSeasonPlaybackPromise(
            ...
            const episodesResult = await apiClient.getEpisodes(
                firstItem.SeriesId || firstItem.Id,
                {
                    IsVirtualUnaired: false,
                    IsMissing: false,
                    SeasonId:
                        startSeasonId && items.length === 1
                            ? startSeasonId
                            : undefined,
            ...
            const getItemAndParts = async function (item) {
                if (
                    ...
                    const additionalParts =
                        await client.getAdditionalVideoParts(user.Id, item.Id);
        ...
        function playWithIntros(items, options) {
            ...
            return getIntros(firstItem, apiClient, options).then(function (
                introsResult
            ) {
        ...
        function playAfterBitrateDetect(
            ...
            const getMediaStreams = isLiveTv
                ? Promise.resolve([])
                : apiClient
                      .getItem(apiClient.getCurrentUserId(), mediaSourceId)
                      .then((fullItem) => {
        ...
        if (appHost.supports("remotecontrol")) {
            import("../../scripts/serverNotifications.js").then(
                ({ default: serverNotifications }) => {
                    Events.on(
                        serverNotifications,
                        "ServerShuttingDown",
